...
namespace FSM
{
	...
	/// </summary>
	public class TransitionAfter<TEvent> : TransitionBase<TEvent>
	{

		public float delay;
		public Func<TransitionAfter<TEvent>, bool> condition;
		public Timer timer;
		...
		public TransitionAfter(
				...
				TEvent to,
				float delay,
				Func<TransitionAfter<TEvent>, bool> condition = null,
